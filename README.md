...
'GPT-4가 고작 수능 국어 3등급이라고?'라는 의문에서 시작된 프로젝트로, 수능 국어를 아주 잘 푸는 AI를 만들어 가고 있습니다. 
...
저희는 프롬프트 엔지니어링과 함께라면, GPT-4가 수능 국어를 훨씬 잘 풀 수 있다고 믿고 있습니다. 

많은 분들이 AI가 수능에서 만점을 받게 기여해주시면 좋겠다는 마음에 레포를 공개하게 되었습니다.

## Result

아무 프롬프트 엔지니어링 없는 GPT-4는 23수능 국어(화작) 86점, 상위 22%이었습니다.
하나의 CoT 프롬프트를 통하여 GPT-4의 성적을 상위 5%(94점)까지 끌어 올렸습니다.
더불어, 13번의 문제 유형에 맞춤화된 프롬프트를 이용하면 상위 4%(96점)까지도 올라갑니다.
